...
const testimonials = [
  ...
  },
  {
    ...
    color: "#7A9E7E",
    stars: 5,
    text: "Growing up in Chennai, my amma made banana stem dishes every week. When we moved to Pune, I couldn't find good quality banana stem anywhere. Stem Native solved that problem completely. The stem is cleaned perfectly — I can cook in 10 minutes!",
  ...
  },
  {
    ...
    color: "#8B6E4E",
    stars: 5,
    text: "My yoga students ask me for detox recommendations and now I tell them all about Stem Native. The juice-ready pack is brilliant — I blend it with coconut water every morning. My digestion has never been better. Premium quality, premium results.",
  ...
  },
  {
    ...
    color: "#2D5A35",
    stars: 5,
    text: "As someone who tracks nutrition obsessively, I love that Stem Native gives me a high-fiber, low-calorie option that's traditionally Indian. The 1kg family pack is excellent value. Customer service on WhatsApp is fast and personal. 10/10.",
  ...
  },
  {
    ...
    color: "#C9A84C",
    stars: 5,
    text: "As a physician, I recommend high-fiber foods to many of my patients for gut health and kidney stones. Banana stem is medically brilliant for both. Stem Native makes it accessible and convenient. I recommend this to all my health-conscious patients.",
  ...
  },
  {
    ...
    color: "#D4716C",
    stars: 5,
    text: "With two kids and a full-time job, I don't have 45 minutes to clean banana stem. Stem Native's pre-cleaned packs are a lifesaver. I made banana stem poriyal in 15 minutes yesterday — my kids actually loved it. Healthy eating made realistic.",
    tag: "Busy Parent",
  },
];
